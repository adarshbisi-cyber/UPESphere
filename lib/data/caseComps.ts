...
export const HEAT_STYLE: Record<HeatLevel, { label: string; cell: string; text: string; sub: string }> = {
  ...
  builds: { label: 'Building up',           cell: 'bg-cyan-500/40 border-cyan-400/60 dark:bg-cyan-500/25 dark:border-cyan-400/50',                                                  text: 'text-cyan-800 dark:text-cyan-100', sub: 'text-cyan-700/80 dark:text-cyan-200/70' },
